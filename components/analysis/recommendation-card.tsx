    ...
    >
      <GlassCard
        className={cn(
          ...
          selected && "border-champagne-500/30 bg-champagne-500/[0.04]"
        )}
        onClick={onSelect}
        hover
        glow={selected}
      ...
      >
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1 min-w-0 pr-3">
            <div className="flex items-center gap-2 mb-1">
              <h4 className="text-white font-medium text-base">{treatment.name}</h4>
              {selected && (
                <motion.span
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="inline-flex items-center gap-1 text-[10px] uppercase tracking-wider font-semibold text-champagne-400 bg-champagne-500/10 px-2 py-0.5 rounded-full"
                >
          ...
          <div
            className={cn(
              ...
              selected
                ? "border-champagne-500 bg-champagne-500 text-stone-900"
                : "border-white/15"
            )}
          >
        ...
        <p className="text-white/55 text-sm leading-relaxed mb-4">{treatment.description}</p>
